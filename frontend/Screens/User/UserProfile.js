        ...
        React.useCallback(() => {
            AsyncStorage.getItem("jwt")
                .then((res) => {
                    ...
                    axios
                        .get(`${baseURL}users/profile`, { // /${context.stateUser.user.sub}
                            headers: { Authorization: `Bearer ${res}` },
                        })
                        .then((response) => { context.dipatch(response.data.token,response.data.user);setUserProfile(response.data.user); })
                })
